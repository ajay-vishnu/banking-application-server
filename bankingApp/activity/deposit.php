<?php
    ...
    if ($conn->query($sqlQuery))    {
        ...
        $sqlQuery = "INSERT INTO transactions (transaction_id, account_id, transaction_type, credit, account_balance, transaction_message) VALUES ($transactionId, $accountId, 'Deposit', $amount, $accountBalance, '$transactionMessage')";
        if (!($conn->query($sqlQuery)))    {
            $transactionId = "";
        }
    }
